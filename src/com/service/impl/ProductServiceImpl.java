...
public class ProductServiceImpl implements ProductService{
	 ...
	 * @return 全部产品
	 */
	public List<Product> queryProduct(Map properties, int pageNo, int pageSize){return productDao.queryProduct(properties, pageNo, pageSize);}
	/**
	 * @description: 统计全部产品
	 ...
	 * @return 统计数
	 */
	public int countProduct(Map properties){return productDao.countProduct(properties);}
	/*-----------------------------------------------set and get method----------------------------------*/
