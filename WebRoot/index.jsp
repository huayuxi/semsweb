	...
	<div id="header">
		<div class="bound">
			...
			<div id="menu">
				<div class="nav">
					<ul>
						<li><a class="index_home" href="index.jsp"><span>首页</span></a></li>
						<li><a class="market_dynamics" href="<%=basePath%>pages/front/news/news.jsp"><span>市场动态</span></a></li>
			...
			<div class="slides">
				<div class="slide autoMaxWidth">
					<div id="bi_2" class="image">
						<a target="_blank" href="#"> <img src="images/2.jpg" name="02"
							style="left:-252px; position:relative;">
						</a>
					</div>
				</div>
				<div class="control">
		...
		<div class="latest-news-index">
			<div class="bound">
				<div class="latest-news">
					...
					<div class="content">
						<a href="#" class="image"> <img
							src="images/iotcomm_001news.jpg" />
						</a>
						<p>
							· 智联信通盛大亮相2013广州光展<span>......</span>
						</p>
						<p>
							· 智联信通盛大亮相2013广州光展<span>......</span>
						</p>
				...
				<div class="video_media">
					<div class="content">
						<a href="#"> <img src="images/videobg.gif" />
						</a>
					</div>
				</div>
				<div class="clear"></div>
			...
			<div class="bound">
				...
				<div class="middle_bg">
					...
					<div class="case_content">
						<h3>全球案例</h3>
						<p>
							<span></span>广深高速单灯智能控制项目
						</p>
						<p>
							<span></span>沈阳大四环新建路段照明智能控制项目
						</p>
						<p>
							<span></span>福建省示范项目云霄县照明节能改造
						</p>
						<p>
							<span></span>甘肃兰州隧道LED灯智能控制项目
						</p>
						<p>
							<span></span>青海西宁全城景观亮化智能控制项目
						</p>
