...
<head>
	...
	<script src="<%=basePath%>js/admin/product/product_add.js" type="text/javascript"></script>
</head>
                 ...
                 <ul>                
                    <li>
                      ...
                      <div class="btn-group dropdown" id="create-type-dropdown">
                       <input type="hidden" name="product.cplm00"/>
                    ...
                    <li id="j-li-lx">
                      ...
                      <div class="btn-group dropdown" id="create-type-dropdown">\
                      	<input type="hidden" name="product.cplx00"/>
                        <button data-toggle="dropdown" class="btn dropdown-toggle">
							<span class="value" id="create-app-type">请选择</span>
							<span class="caret"></span>
						</button>
